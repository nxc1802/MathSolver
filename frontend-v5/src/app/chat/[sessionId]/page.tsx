...
import { messageFromApi } from "@/shared/lib/chat-messages";
import {
  readSplitPercent,
  writeSplitPercent,
  ...
  MAIN_SPLIT_MIN_PCT,
  MAIN_SPLIT_MAX_PCT,
} from "@/shared/lib/session-ui-storage";
import {
  loadGeometryState,
  saveGeometryState,
  type GeometryState,
} from "@/shared/lib/session-geometry-cache";
import {
  saveActiveJob,
  getActiveJob,
  clearActiveJob,
